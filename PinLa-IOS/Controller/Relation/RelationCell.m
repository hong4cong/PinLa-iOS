...
- (void)contentWithRelationEntity:(UserEntity *)userEntity{
   [self.hv_avatar sd_setImageWithURL:[NSURL URLWithString:userEntity.user_icon] placeholderImage:[UIImage imageNamed:@"img_prop_def"]];
   [self.lb_nickname setText:userEntity.nick_name];
