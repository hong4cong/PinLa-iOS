...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDForegroundColor = [UIColor colorWithRed:0.9869 green:0.9869 blue:0.9869 alpha:1.0];
        if ([UIFont respondsToSelector:@selector(preferredFontForTextStyle:)]) {
            ...
            SVProgressHUDBackgroundColor = [UIColor colorWithRed:0.9869 green:0.9869 blue:0.9869 alpha:1.0];
...
- (UIView *)hudView {
    if(!_hudView) {
        ...
        _hudView.layer.shadowRadius = 1;
        _hudView.layer.shadowOpacity = 0.3f;
        _hudView.layer.shadowOffset = CGSizeMake(0, 0);
        _hudView.layer.shadowColor = [UIColor blackColor].CGColor;
//        _hudView.layer.shadowPath = [UIBezierPath bezierPathWithRoundedRect:_hudView.bounds cornerRadius:_hudView.layer.cornerRadius].CGPath;
